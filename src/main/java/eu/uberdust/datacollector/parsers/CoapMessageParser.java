...
public class CoapMessageParser implements Runnable {
    ...
    public void run() {
        ...
        if(payload[0] == 1)   // check for broadcasting message
        {
            ...
            int[] mpayload = new int["52:01:00:00:9b:2e:77:65:6c:6c:2d:6b:6e:6f:77:6e:04:63:6f:72:65".split(":").length];
            int i = 0;
            for (String mbyte : "52:01:00:00:9b:2e:77:65:6c:6c:2d:6b:6e:6f:77:6e:04:63:6f:72:65".split(":")) {
        ...
        else if (payload[0] == 51) // coap message
        {
            ...
            if(payload[2] == 0 && payload[3] == 0)
            {
                ...
                String stringCap = Arrays.toString(inPayload);
                LOGGER.info(stringCap);
