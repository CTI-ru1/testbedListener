...
//                      this.sendCommand(new AtCommand("IR", new int[] {0x13, 0x88}));
            ...
            log.info("MY is " + xbee.sendAtCommand(new AtCommand("AP",2)));
            log.info("MY is " + xbee.sendAtCommand(new AtCommand("WR")));
            log.info("MY is " + xbee.sendAtCommand(new AtCommand("FR")));
